...
def draw_sav_img(idx):
    ...
    # cv2.line(img, lf_line0, lf_line5, (255, 150, 0))
    # cv2.line(img, lf_line0, lf_line17, (255, 150, 0))
    # cv2.line(img, lf_line9, lf_line13, (255, 150, 0))
    # cv2.line(img, lf_line13, lf_line17, (255, 150, 0))
    # cv2.line(img, lf_line5, lf_line9, (255, 150, 0))
    ...
    # cv2.line(img, rg_line0, rg_line5, (0, 0, 255))
    # cv2.line(img, rg_line0, rg_line17, (0, 0, 255))
    # cv2.line(img, rg_line9, rg_line13, (0, 0, 255))
    # cv2.line(img, rg_line13, rg_line17, (0, 0, 255))
    # cv2.line(img, rg_line5, rg_line9, (0, 0, 255))
    ...
    cv2.imwrite('./test_img/' + str(f'img{idx}') +'.jpg', img)

def create_video():
    img_array = []
    for filename in tqdm(glob.glob('H:/test_img/*.jpg')):
        img = cv2.imread(filename)
        height, width, layers = img.shape
        size = (width, height)
        img_array.append(img)
    out = cv2.VideoWriter('test_img_del_6.avi', cv2.VideoWriter_fourcc(*'DIVX'), 15, size)
